...
import { NButton, NConfigProvider, NLayout, NLayoutContent, NLayoutHeader, NLayoutSider, NMenu } from 'naive-ui'
...
const themeOverrides = { common: { primaryColor: '#315ee7', primaryColorHover: '#2a54d1', primaryColorPressed: '#2349b8', borderRadius: '4px' } }
    ...
    <NLayout style="min-height: 100vh">
      <NLayoutHeader bordered style="height: 56px; padding: 0 24px; display: flex; align-items: center; justify-content: space-between;">
        <div style="display: flex; align-items: baseline; gap: 16px;">
          <span style="font-size: 18px; font-weight: 700; color: var(--pri);">{{ t('app.title') }}</span>
